...
import ${package}.${artifactId}.common.util.StringUtils;
...
@PropertySources({
        ...
        @PropertySource(value = "classpath:/resource-${symbol_dollar}{spring.profiles.active}.properties", ignoreResourceNotFound = true)
})
